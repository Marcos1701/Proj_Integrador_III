...
const RegistrationFormLogin: React.FC = () => {
  ...
  return (
    <form className="flex relative flex-col grow px-9 pt-8 pb-3 w-full max-w-[500px] text-sm text-black bg-white rounded-xl
     border border-solid shadow-2xl border-zinc-500 max-md:max-w-full max-md:px-5 max-md:py-5">
      ...
      <InputField label="Senha" placeholder="Insira sua senha" type="password"/>
      ...
      <div className="self-center mt-5">
        <span className="text-zinc-500">Não possui uma conta?</span>
        <span className="font-semibold"> Realize o cadastro</span>
      </div>
    </form>
  );
};
