...
const Banner: React.FC = () => {
  return (
    <section className={`${styles.banner} flex flex-col items-start px-20 py-7 w-full font-semibold bg-teal-400 shadow-sm max-md:px-5 max-md:max-w-full max-sm:pt-2`}>
